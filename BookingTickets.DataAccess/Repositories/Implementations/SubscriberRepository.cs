...
public class SubscriberRepository : Repository<SubscribeEmail>, ISubscriberRepository
{
    public SubscriberRepository(BookingTicketsDbContext dbContext) : base(dbContext)
    {
    }
}
